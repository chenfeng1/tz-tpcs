...
@ContextConfiguration("classpath:xml/spring-oxm2.xml")
public class TestOxm2 {
    ...
    public void test3() throws IOException {
        ...
        String filename = "d:/resources.xml";
        oxMapper.writeObjectToXml(list, filename);

        List resList = (List) oxMapper.readObjectFromXml(filename);
